...
3. Use the inspector to set frameRate and framesToCapture 1 and 1
4. Choose your desired resolution in Unity's Game window (must be less than or equal to your screen resolution) Shift+CTRL+F
